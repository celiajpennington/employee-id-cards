...
function newEmployee()
{
  ...
  .prompt ([
    ...
    name: 'role', choices: ['Engineer', 'Intern']},
    {type: 'input',
    ...
    name: 'email'},
    {type: 'input',
    message: "Enter the employee's github username", when: (list) => list.role == "Engineer", 
    name: "github"},
    {type: 'input',
    message: "Enter the employee's school", when: (list) => list.role == "Intern", 
    name: "school"}, 
    {type: 'confirm',
    message: "Would you like to add another employer", 
    name: 'add'},
...
.then ((response) => {
  ...
  if(response.role == "Intern"){
    ...
    let github = responseonse.github;
